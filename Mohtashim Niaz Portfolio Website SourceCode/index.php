...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="assets/img/<?= $data['profilepicture'] ?>" alt="" class="img-fluid rounded-circle">
    ...
    <main id="main">
        ...
        <section id="skills" class="skills section-bg">
            <div class="container">
                ...
                <p>These scores are given using AI testcases.</p>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    ?>
                        <div class="col-lg-4 col-md-6 portfolio-item">
                            ...
                            <h4 class="text-center mt-2"><?= $data5['projectname'] ?></h4>
                        </div>
                    <?php
                    }
                    ?>
...
-->
            <div class="credits">
                Developed by <a href="#">22-SE-42</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
